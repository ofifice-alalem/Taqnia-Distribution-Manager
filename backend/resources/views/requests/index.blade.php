                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('requests.show', $request->id) }}" class="btn btn-sm btn-outline-primary" title="عرض التفاصيل">
                                        <i class="bi bi-eye"></i>
                                    </a>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    @elseif($request->status && $request->status->status == 'approved')
                                        ...
                                        @endphp
                                        @if(!$isDocumented)
                                            <a href="{{ route('requests.upload-document', $request->id) }}" class="btn btn-sm btn-warning" title="توثيق">
...
function cancelRequest(id) {
    if(confirm('هل أنت متأكد من إلغاء هذا الطلب؟')) {
        window.location.href = `/requests/${id}/cancel`;
    }
}
