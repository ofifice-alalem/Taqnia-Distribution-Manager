                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="{{ route('marketer.returns.show', $return->id) }}" class="btn-action btn-view" title="عرض التفاصيل">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </div>
                        </td>
    ...
    @forelse($returns as $return)
        <div class="return-card">
            ...
            <div class="card-footer">
                <a href="{{ route('marketer.returns.show', $return->id) }}" class="btn btn-sm btn-primary">
